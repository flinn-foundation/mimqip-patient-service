package org.flinnfoundation.old.dao.recommend.dao;
...
import org.flinnfoundation.old.dao.beans.request.RequestPrescriptionBean;
import org.flinnfoundation.old.dao.beans.response.*;
import org.flinnfoundation.old.dao.dao.AbstractBaseDao;
import org.flinnfoundation.old.dao.dao.DaoRequestManager;
import org.flinnfoundation.old.dao.dao.imp.LabDaoImp;
import org.flinnfoundation.old.dao.dao.imp.PatientDaoImp;
import org.flinnfoundation.old.dao.dao.imp.PrescriptionDaoImp;
...
import org.flinnfoundation.old.dao.recommend.beans.RecommendPatientInfoBean;
import org.flinnfoundation.old.dao.recommend.beans.RecommendRuleCriteriaBean;
import org.flinnfoundation.old.dao.recommend.beans.response.ResponseRuleBean;
import org.flinnfoundation.old.dao.recommend.dao.imp.GuidelineReasonDaoImp;
import org.flinnfoundation.old.dao.util.RecommendUtils;
import org.flinnfoundation.service.OldPatientService;
...
public class DaoRecommendRequestManager extends AbstractBaseDao {
	...
	//Seems like all this can be move to the javascript to display the current stage. I think all that it is doing is checking to see if there are any treatments. Setting stage 1 if none
	//Or Calling the stage recommendation if there are. We should probably just send over the current stage when the page is loaded.
...
//					RecommendDiagnosisBean[] diagnoses = new RuleDaoImp().getAllDiagnoses(connection);
					...
					int stage = RecommendUtils.stageRecommendation(input.getInitialstaging().getDiagnosis(),input.getInitialstaging().getTreatments(), diagnoses);
