...
import org.flinnfoundation.old.dao.dao.AuthcodeDao;
import org.flinnfoundation.old.dao.dao.imp.AppUserDaoImp;
import org.flinnfoundation.old.dao.dao.imp.TreatmentDaoImp;
import org.flinnfoundation.old.dao.recommend.beans.RecommendDiagnosisBean;
import org.flinnfoundation.old.dao.recommend.beans.request.RequestMessageBean;
import org.flinnfoundation.old.dao.recommend.beans.request.RequestRuleBean;
import org.flinnfoundation.old.dao.recommend.beans.request.RequestSettingBean;
import org.flinnfoundation.old.dao.recommend.beans.response.*;
import org.flinnfoundation.old.dao.recommend.dao.imp.MessageDaoImp;
import org.flinnfoundation.old.dao.recommend.dao.imp.SettingDaoImp;
...
public class DaoRecommendManager extends AbstractBaseDao {
	...
	public ResponseMessageBean findMessage(int messageid) throws Exception {
		...
		connection = getConnection(); // Get connection
		List<ResponseMessageBean> messages = (new MessageDaoImp()
...
//			rtnList = new RuleDaoImp().findAllRules(bean, orderBy, connection);
	...
	public ResponseRuleBean findRule(int ruleid) throws Exception {
		...
		connection = getConnection(); // Get connection
//		List<ResponseRuleBean> rules = (new RuleDaoImp()
//				.find(bean, null, connection));
...
//		allDiagnoses = new RuleDaoImp().getAllDiagnoses(connection);
	...
	public ResponseSettingBean findSetting(int settingid) throws Exception {
		...
		connection = getConnection(); // Get connection
		List<ResponseSettingBean> settings = (new SettingDaoImp()
				.find(bean, null, connection));
