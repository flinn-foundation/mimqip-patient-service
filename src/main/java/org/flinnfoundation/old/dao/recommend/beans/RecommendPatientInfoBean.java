...
import org.flinnfoundation.old.dao.beans.PatientStatusBean;
import org.flinnfoundation.old.dao.beans.response.ResponseLabBean;
import org.flinnfoundation.old.dao.beans.response.ResponsePatientBean;
import org.flinnfoundation.old.dao.beans.response.ResponsePrescriptionBean;
...
public class RecommendPatientInfoBean extends AbstractDataBean
{
	...
	private void setConsistentInfo(RecommendDiagnosisBean[] diagnoses) {
		...
		HashMap<String,String> consistencymap = RecommendUtils.consistency(info,prescriptioninfo,diagnosis,diagnoses);
