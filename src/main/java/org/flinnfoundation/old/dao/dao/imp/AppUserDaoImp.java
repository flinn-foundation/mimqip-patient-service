...
public class AppUserDaoImp extends AppUserDao
{
	...
	public int handleLastLoginUpdate(int appUserID, Connection connection) throws Exception
	{
		...
		if (appUserID > 0)
		{
			result = (new AppUserDaoImp().updateLastLoggedIn(appUserID, connection));
		}
