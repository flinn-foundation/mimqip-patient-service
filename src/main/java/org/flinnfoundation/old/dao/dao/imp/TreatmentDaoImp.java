...
import org.flinnfoundation.old.dao.beans.request.RequestTreatmentBean;
import org.flinnfoundation.old.dao.beans.response.*;
import org.flinnfoundation.old.dao.dao.DaoRequestManager;
import org.flinnfoundation.old.dao.dao.TreatmentDao;
	...
	public ResponseTreatmentBean getTreatmentByGenericDrugNameAndForm(String genericDrugName, String form, Connection connection) throws Exception
	{
		...
		if (responseTreatmentBean == null) {
			if (genericDrugName != null && genericDrugName.length() > 0)
			{
				...
				if (treatments != null && treatments.size() > 0)
				{
					// Find the org.flinnfoundation.old.dao.dao.beans that match, and get specific.
