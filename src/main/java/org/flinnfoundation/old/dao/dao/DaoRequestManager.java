...
import org.flinnfoundation.old.dao.util.PatientLog;
...
public class DaoRequestManager extends AbstractBaseDao
{
	...
	public ResponseContainerBean handleRequest(RequestContainerBean input, HttpServletRequest request)
	{
		...
		// The session bean contains the authenticated user's ResponseAppUser and ResponseFacility org.flinnfoundation.old.dao.dao.beans.
