...
public class DBConnectionPool
{
	 ...
	 * <p>
	 * If MySQL.properties file in flinn.org.flinnfoundation.old.dao.dao.dao.dbconnection has "UseThisFileForDatasourceInfo" set to "true" then Connection Pool will be automatically
	...
	private static boolean checkInitFromMySqlProperties()
	{
		...
		try
		{
			ResourceBundle p = ResourceBundle.getBundle("flinn.org.flinnfoundation.old.dao.dao.dao.dbconnection.MySQL");
	...
	private static void initFromMySqlProperties()
	{
		try
		{
			if (staticDS == null)
			{
				// Get MySQL.properties file in flinn.org.flinnfoundation.old.dao.dao.dao.dbconnection
				ResourceBundle p = ResourceBundle.getBundle("flinn.org.flinnfoundation.old.dao.dao.dao.dbconnection.MySQL");
