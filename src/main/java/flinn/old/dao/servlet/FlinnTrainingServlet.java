package flinn.old.dao.servlet;

import com.google.gson.Gson;
import flinn.old.dao.beans.BeanInterface;
...
import flinn.old.dao.dao.DaoRequestManager;
...
public class FlinnTrainingServlet extends HttpServlet {
	...
	{ "<a href=\"http://en.wikipedia.org/wiki/JSON\">JSON WIKI</a>", "XML with the use of JAXB", "Java Object to XML with the java.flinn.old.dao.beans.encoder" };
	...
	private RequestContainerBean handleBeanInput(char[] buf, int buflen, String format) throws Exception {
		...
		{
			// String input="<?xml version=\"1.0\" encoding=\"UTF-8\"?><java version=\"1.6.0_13\" class=\"java.flinn.old.dao.beans.XMLDecoder\"><object class=\"com.healthmedia.stepbystep.flinn.old.dao.beans.RequestContainerBean\"><void property=\"action\"><object class=\"com.healthmedia.stepbystep.flinn.old.dao.beans.RequestActionBean\"><void property=\"keycode\"><string>password</string></void><void property=\"level\"><string>profile</string></void><void property=\"type\"><string>read</string></void></object></void><void property=\"login\"><string>somevalueinlogin</string></void></object></java>";
