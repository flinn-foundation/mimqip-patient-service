...
import flinn.old.dao.beans.request.RequestGuidelineReasonBean;
import flinn.old.dao.beans.response.ResponseGuidelineReasonBean;
...
public abstract class GuidelineReasonDao {
	...
	public int create(final RequestGuidelineReasonBean bean, Connection connection)
		...
		if (bean != null) {
			...
			insertStatement.setString(2, flinn.old.dao.util.DateString.now());
