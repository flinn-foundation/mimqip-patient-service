package flinn.old.dao.recommend.beans;

import flinn.old.dao.beans.AbstractDataBean;
import flinn.old.dao.beans.PatientStatusBean;
import flinn.old.dao.beans.response.ResponseLabBean;
...
public class RecommendPatientInfoBean extends AbstractDataBean
{
	...
	private void setConsistentInfo(RecommendDiagnosisBean[] diagnoses) {
		...
		HashMap<String,String> consistencymap = flinn.old.dao.util.RecommendUtils.consistency(info,prescriptioninfo,diagnosis,diagnoses);
