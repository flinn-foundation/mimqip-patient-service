...
import flinn.old.dao.rcopia.service.RcopiaSenderService.PreferredMapper;
import flinn.old.dao.util.ApplicationProperties;
...
public class RcopiaTransformationService
{
	...
	private static JAXBContext initJaxbContext()
	{
		try
		{
			return JAXBContext.newInstance("flinn.flinn.old.dao.rcopia.model");
		}
