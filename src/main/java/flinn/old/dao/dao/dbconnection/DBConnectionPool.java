...
public class DBConnectionPool
{
	 ...
	 * <p>
	 * If MySQL.properties file in flinn.flinn.old.dao.dao.dbconnection has "UseThisFileForDatasourceInfo" set to "true" then Connection Pool will be automatically
	...
	private static boolean checkInitFromMySqlProperties()
	{
		...
		try
		{
			ResourceBundle p = ResourceBundle.getBundle("flinn.flinn.old.dao.dao.dbconnection.MySQL");
	...
	private static void initFromMySqlProperties()
	{
		try
		{
			if (staticDS == null)
			{
				// Get MySQL.properties file in flinn.flinn.old.dao.dao.dbconnection
				ResourceBundle p = ResourceBundle.getBundle("flinn.flinn.old.dao.dao.dbconnection.MySQL");
