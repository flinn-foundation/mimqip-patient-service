...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2017-04-10T22:52:28.831-04:00")
...
public interface PatientsApi {
    ...
    ResponseEntity<Void> updatePatientById(@ApiParam(value = "ID of patient to fetch",required=true ) @PathVariable("patientId") Long patientId,
         @NotNull @ApiParam(value = "diagnosis", required = true) @RequestParam(value = "diagnosis", required = true) String diagnosis);
