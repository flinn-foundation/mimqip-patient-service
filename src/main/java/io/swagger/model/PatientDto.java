...
public class PatientDto   {
  ...
  public enum DiagnosisEnum {
    ...
    @JsonCreator
    public static DiagnosisEnum fromValue(String text) {
      for (DiagnosisEnum b : DiagnosisEnum.values()) {
        if (String.valueOf(b.value).equals(text)) {
          return b;
        }
      }
  ...
  private DiagnosisEnum diagnosis = null;
  ...
  **/
  ...
  public PatientDto diagnosis(DiagnosisEnum diagnosis) {
